...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
          ...
          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, HM_DOT, KC_SLSH,
                                     KC_ESC, CKC_SPC, KC_TAB,    CKC_ENT, CKC_BSPC,  CKC_DEL
      ),
    [_SYM] = LAYOUT(
        KC_GRV,  KC_LABK, KC_RABK, KC_DQUO, KC_DOT,     KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,
        KC_EXLM, KC_LPRN, KC_RPRN, KC_QUOT, KC_COLN,    KC_NO, OS_LCTL, OS_LSFT, OS_LALT, OS_LGUI,
        KC_CIRC, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR,    KC_NO, KC_NO,   KC_NO,   OS_RALT, KC_NO,
                                 KC_AMPR, KC_UNDS, KC_MINS,    XXXXXXX, KC_NO, KC_NO
    ),
    [_NUM] = LAYOUT(
                   KC_NO, KC_7, KC_8, KC_9,     KC_NO,    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,
                   KC_NO, KC_4, KC_5, KC_6,    KC_EQL,    KC_NO, OS_LCTL, OS_LSFT, OS_LALT, OS_LGUI,
                   KC_NO, KC_1, KC_2, KC_3,   KC_BSLS,    KC_NO, KC_NO,   KC_NO,   OS_RALT, KC_NO,
                                       KC_DOT, KC_0, KC_MINS,    KC_NO, XXXXXXX, KC_NO
      ),
   [_FUN] = LAYOUT(
                 KC_F12, KC_F7, KC_F8, KC_F9, KC_PSCR,    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,
                 KC_F11, KC_F4, KC_F5, KC_F6, KC_SCRL,    KC_NO, OS_LCTL, OS_LSFT, OS_LALT, OS_LGUI,
                 KC_F10, KC_F1, KC_F2, KC_F3, KC_PAUS,    KC_NO, KC_NO,   KC_NO,   OS_RALT, KC_NO,
                               TO(_GAMING), CW_TOGG, KC_CAPS,    KC_NO, KC_NO, XXXXXXX
      ),
   [_NAV] = LAYOUT(
             KC_UNDO, KC_CUT, KC_COPY, KC_PSTE, KC_NO,    KC_MPRV, KC_MPLY, KC_MSTP, KC_MNXT, KC_VOLU,
             OS_LGUI,  OS_LALT, OS_LSFT, OS_LCTL, KC_NO,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MUTE,
             WM_1,    WM_2,   WM_3,    WM_4,     WM_5,    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_VOLD,
                                       KC_NO, XXXXXXX, KC_NO,    KC_NO, KC_NO, KC_NO
      ),
   [_GAMING] = LAYOUT(
          KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
          KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,
          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT,TO(_BASE),
