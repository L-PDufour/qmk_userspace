...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT(
        KC_TILD, KC_CIRC, KC_LBRC, KC_RBRC, KC_SLSH,    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,
        KC_COLN, KC_EXLM, KC_LPRN, KC_RPRN, KC_QUES,    KC_NO, OS_LCTL, OS_LSFT, OS_LALT, OS_LGUI,
        KC_AT,   KC_HASH, KC_LCBR, KC_RCBR, KC_DLR,     KC_NO, KC_NO,   KC_NO,   OS_RALT, KC_NO,
